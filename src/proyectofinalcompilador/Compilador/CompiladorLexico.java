...
public class CompiladorLexico {
    ...
    private String obtenerNombreToken(int tokenCode) {
        switch (tokenCode) {
            case sym.Comillas: return "Comillas";
            case sym.T_dato: return "Tipo de dato";
            case sym.Int: return "Int";
            case sym.Cadena: return "String";
            ...
            case sym.Multiplicacion: return "Multiplicación";
            case sym.Division: return "División";
            case sym.Op_logico: return "Operador Lógico";
            case sym.Op_incremento: return "Operador Incremento";
            case sym.Op_relacional: return "Operador Relacional";
            case sym.Op_atribucion: return "Operador Atribución";
            case sym.Op_booleano: return "Operador Booleano";
            case sym.Parentesis_a: return "Paréntesis Apertura";
            case sym.Parentesis_c: return "Paréntesis Cierre";
            case sym.Llave_a: return "Llave Apertura";
            case sym.Llave_c: return "Llave Cierre";
            case sym.Corchete_a: return "Corchete Apertura";
            case sym.Corchete_c: return "Corchete Cierre";
            case sym.Main: return "Main";
            case sym.P_coma: return "Punto y coma";

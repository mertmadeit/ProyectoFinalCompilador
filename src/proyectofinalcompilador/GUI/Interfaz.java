...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MenuItemGuardar.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/proyectofinalcompilador/icons/icons8-save-16.png"))); // NOI18N
        ...
        MenuItemSalir.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/proyectofinalcompilador/icons/icons8-exit-16.png"))); // NOI18N
        ...
        MenuItemCopiar.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/proyectofinalcompilador/icons/icons8-copy-16.png"))); // NOI18N
        ...
        MenuItemCortar.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/proyectofinalcompilador/icons/icons8-cut-16.png"))); // NOI18N
        ...
        MenuItemAcercarDe.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/proyectofinalcompilador/icons/icons8-help-16.png"))); // NOI18N
    ...
    private void MenuItemCompilarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_MenuItemCompilarActionPerformed
        ...
        CompiladorLexico compilador = new CompiladorLexico();
        boolean exito = compilador.compilar(codigoFuente);

        // Limpiar tablas anteriores
        DefaultTableModel modeloLexico = (DefaultTableModel) TableLexico.getModel();
        modeloLexico.setRowCount(0);

        // Llenar tabla con tokens siempre, incluso si hay errores
        for (CompiladorLexico.TokenInfo token : compilador.getTokens()) {
            Object[] fila = { token.tipo, token.lexema, String.valueOf(token.linea) };
            modeloLexico.addRow(fila);
        }

        // Mostrar tokens si la compilación fue exitosa
        if (exito) {
            TextAreaSalida.setText("Compilación léxica completada exitosamente.\n" +
                    "Tokens encontrados: " + compilador.getTokens().size());
        } else {
            // Mostrar errores
            StringBuilder mensajeError = new StringBuilder("Errores en compilación léxica:\n\n");
            for (String error : compilador.getErrores()) {
